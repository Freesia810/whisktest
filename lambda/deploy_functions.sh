...
/home/freesia/RainbowCake-ASPLOS24/demo/wsk -i action update ac --kind nodejs:20 --main main --memory $memory --timeout $timeout index.zip
...
/home/freesia/RainbowCake-ASPLOS24/demo/wsk -i action update is --kind nodejs:20 --main main --memory $memory --timeout $timeout index.zip
...
/home/freesia/RainbowCake-ASPLOS24/demo/wsk -i action update oi --kind nodejs:20 --main main --memory $memory --timeout $timeout index.zip
...
wsk -i action update dh --kind nodejs:20 --main main --memory $memory --timeout $timeout index.zip
